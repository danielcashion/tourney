        ...
        return (
            <div className={styles['container']}>
                ...
                <form className={styles['form']}>
                    <button type="button" onClick={this.onGoogleSignIn} className={styles["google-button"]}>
                        <span className={styles["google-button__icon"]}>
                        ...
                        <span className={styles["google-button__text"]}>Sign in with Google</span>
                    </button>
                    <p>OR</p>
                    ...
                    <button type="button" onClick={this.onSignIn} className={styles["signIn"]}>Sign In</button>
                </form>
            </div>
        );
    }
